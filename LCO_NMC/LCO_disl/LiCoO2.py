...
fp.write("\n6\tatom types\t# 3 cores and 3 shells\n")
fp.write("3\tbond types\n")
...
fp.write("2  %.5f\t# Co core\n" % (58.933*(1-ratio)))
fp.write("3  %.5f\t# O  core\n" % (15.999*(1-ratio)))
fp.write("4  %.5f\t# Li shell\n" % (6.94*ratio))
fp.write("5  %.5f\t# Co shell\n" % (58.933*ratio))
fp.write("6  %.5f\t# O  shell\n" % (15.999*ratio))
    ...
    for j in range(Ny):
        for k in range(Nz):
            ...
            for XYZ in Li:
                ...
                Natom = Natom + 1
                fp.write("%6d %6d %6d  %6.3f  %16.10f %16.10f %16.10f\n" %(Natom,Nmol,4,Y[1],xyz[0],xyz[1],xyz[2]))
            ...
            for XYZ in M:
                ...
                Natom = Natom + 1
                fp.write("%6d %6d %6d  %6.3f  %16.10f %16.10f %16.10f\n" %(Natom,Nmol,M_type+3,Y[M_type],xyz[0],xyz[1],xyz[2]))
                bonds.append([Nmol,M_type,Natom-1,Natom])
            for XYZ in O:
                xyz = (XYZ+R) % box
                Natom = Natom + 1
                Nmol = Nmol + 1
                fp.write("%6d %6d %6d  %6.3f  %16.10f %16.10f %16.10f\n" %(Natom,Nmol,3,q_Y[3],xyz[0],xyz[1],xyz[2]))
                Natom = Natom + 1
                fp.write("%6d %6d %6d  %6.3f  %16.10f %16.10f %16.10f\n" %(Natom,Nmol,6,Y[3],xyz[0],xyz[1],xyz[2]))
